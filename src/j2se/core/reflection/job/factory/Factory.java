package j2se.core.reflection.job.factory;
...
public class Factory {
    ...
    public IDepart createIDepart(AppType appType) {
        ...
        switch (appType) {
            case mysql:
                dao = new j2se.core.reflection.job.mysqlDaoImpl.DepartService();
                break;
            case mssql:
                dao = new j2se.core.reflection.job.mssqlDaoImpl.DepartService();
                break;
            default:
                break;
        }
    ...
    private String getConfig() {
        ...
        File file = new File("src/j2se/core/reflection/job/config.xml");
